...
public class MMenu extends Application{
    ...
    Image bug = new Image("pic/Cat.png");
    GraphicsContext g = canvas.getGraphicsContext2D();
    BorderPane borderPane = new BorderPane();
		Scene scene = new Scene(borderPane,500,700);
    Label gameName = new Label("Hungry Caterpillar");
    ...
    String currentFontFile = "CabinSketch-Bold.ttf";
  	...
  	Font bgFont = Font.loadFont(fontStream, 22);
		Font bgFont2 = Font.loadFont(fontStream, 40);
    Main m;
    ...
    // animation time
    public static final long duration = 80000;
	...
	private void draw(GraphicsContext g, Image bg) {
	  g.drawImage(bg, (canvas.getWidth()/2)-210, 20);
	}
